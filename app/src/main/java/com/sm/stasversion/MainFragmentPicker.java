...
public class MainFragmentPicker extends Fragment {
    ...
    public static MainFragmentPicker newInstance(Config config) {
        Bundle args = new Bundle();
        args.putParcelable(EXTRA_CONFIG, config);

        MainFragmentPicker fragment = new MainFragmentPicker();

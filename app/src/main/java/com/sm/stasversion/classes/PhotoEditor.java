...
public class PhotoEditor implements BrushViewChangeListener {
        ...
        multiTouchListener.setOnGestureControl(new MultiTouchListener.OnGestureControl() {
            ...
            public void onLongClick() {
                ...
                if (mOnPhotoEditorListener != null) {
                    mOnPhotoEditorListener.onEditTextChangeListener(textRootView, textInput, currentTextColor, null, "");
                }
            }
        });
            ...
            public void onBitmapReady(Bitmap saveBitmap) {
                new AsyncTask<String, String, Bitmap>() {
                    ...
                    protected void onPostExecute(Bitmap bitmap) {
                        ...
                        Bitmap b1 = BitmapUtil.removeTransparency(rl.getDrawingCache());

                        if (b1 != null) {
                            if (saveSettings.isClearViewsEnabled()) clearAllViews();
                            onSaveBitmap.onBitmapReady(b1);
                        } else {
    ...
    public static class Builder {
         ...
         */
        public Builder(Context context, PhotoEditorView photoEditorView, RelativeLayout r) {

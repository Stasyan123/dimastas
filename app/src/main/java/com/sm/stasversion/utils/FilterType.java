...
import com.sm.stasversion.videoUtils.FilterAdjuster;
...
public enum FilterType {
    ...
    public static List<com.sm.stasversion.videoUtils.FilterType> createFilterList() {
        return Arrays.asList(com.sm.stasversion.videoUtils.FilterType.values());
    }

    public static GlFilter createGlFilter(com.sm.stasversion.videoUtils.FilterType filterType, Context context) {
        switch (filterType) {
            case DEFAULT:
                return new GlFilter();
            case BILATERAL_BLUR:
    ...
    public static FilterAdjuster createFilterAdjuster(com.sm.stasversion.videoUtils.FilterType filterType) {
        switch (filterType) {
            case BILATERAL_BLUR:

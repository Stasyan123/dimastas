...
public class GPUPlayerRendererO extends GlFrameBufferObjectRenderer implements SurfaceTexture.OnFrameAvailableListener {
    ...
    private final GPUPlayerViewO glPreview;

    private float aspectRatio = 1f;

    private SimpleExoPlayer simpleExoPlayer;

    GPUPlayerRendererO(GPUPlayerViewO glPreview) {
        super();
